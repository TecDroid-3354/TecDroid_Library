...
public class SwerveTunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
            .withCurrentLimits(
                    new CurrentLimitsConfigs()
                            // Initially, full 40 amps of supply. This should be lowered in battery-intense sequences.
                            .withSupplyCurrentLimit(Amps.of(40))
                            .withSupplyCurrentLimitEnable(true)
                            .withStatorCurrentLimit(Amps.of(80.0)) // Normally 120.0, have to test
                            .withStatorCurrentLimitEnable(true)
            );
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                    // Half maximum supply as drive
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.450);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.116455078125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.4853515625);
